...
import testsuite.provider.Test_2_Provider;
import comp.IRequest;
import comp.IResponse;
import comp.IUrl;
import org.junit.Test;

public class Test_2_Basic_Response_Request_Url_Testing extends AbstractTestFixture<Test_2_Provider> {
	@Test
	public void helloWorld() throws Exception {
		Test_2_Provider ueb = createInstance();
		ueb.helloWorld();
	}
	...
	@Override
	protected Test_2_Provider createInstance() {
		return new Test_2_Provider();
	}
}
