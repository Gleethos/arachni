...
import testsuite.provider.Test_5_Provider;
...
import testsuite.unittests.mocks.Ueb5TestPlugin;

/* Placeholder */
public class Test_5_More_PluginManager_And_File_Plugin extends AbstractTestFixture<Test_5_Provider> {
	...
	@Override
	protected Test_5_Provider createInstance() {
		return new Test_5_Provider();
	}
	...
	public void HelloWorld() throws Exception {
		Test_5_Provider ueb = createInstance();
		ueb.helloWorld();
	}
	...
	public void pluginmanager_should_add_plugin() throws InstantiationException, IllegalAccessException, ClassNotFoundException {
		...
		boolean found = false;
		for (IPlugin p : obj.getPlugins()) {
			if (p instanceof Ueb5TestPlugin)
				found = true;
		}
	...
	private void setupStaticFilePlugin(Test_5_Provider ueb, String fileName) throws FileNotFoundException {
