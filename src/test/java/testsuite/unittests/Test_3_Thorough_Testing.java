...
import testsuite.provider.Test_3_Provider;
import comp.IPlugin;
...
/* Placeholder */
public class Test_3_Thorough_Testing extends AbstractTestFixture<Test_3_Provider> {
	...
	@Override
	protected Test_3_Provider createInstance() {
		return new Test_3_Provider();
	}
	...
	public void HelloWorld() throws Exception {
		Test_3_Provider ueb = createInstance();
		ueb.helloWorld();
	}
